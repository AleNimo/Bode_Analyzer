...
void GraficoView::Enter_Freq()
{
	float freq_max = 200000;
	float freq_min = 2;
	float points_decade = 100;
	...
	else if (freq_max < 100)
		//Graficamos desde 10
		range_min = 10;

	else if  (freq_max < 1000)
		//Graficamos desde 100
		range_min = 100;

	else if  (freq_max < 10000)
		//Graficamos desde 1k
		range_min = 1000;

	else if  (freq_max < 100000)
		//Graficamos desde 10k
		range_min = 10000;

	else if (freq_max < 1000000)
		//Graficamos desde 100k
		range_min = 100000;
